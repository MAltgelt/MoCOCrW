...
{
    return OpenSSLLibMockManager::getMockInterface().SSL_X509_CRL_get0_nextUpdate(x);
}
const ASN1_TIME* OpenSSLLib::SSL_X509_CRL_get0_lastUpdate(const X509_CRL* x) noexcept
{
    return OpenSSLLibMockManager::getMockInterface().SSL_X509_CRL_get0_lastUpdate(x);
}
